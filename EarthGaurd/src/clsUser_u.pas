...
type
  ...
  public
    { public declarations }
    constructor Create(pName, pSurname, pUsername, pEmailAddress, pPassword, pUserType: string; pGender: string; pPhoneNumber: integer);
...
constructor TUser.Create(pName, pSurname, pUsername, pEmailAddress, pPassword, pUserType: string;
  pGender: string; pPhoneNumber: integer);
begin
